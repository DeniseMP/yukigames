				...
				<?php
					...
					while($arr = mysql_fetch_array($dados))
					{
						...
						if($count >3)
						{
							...
							echo "<section class='col-md-4'><a href='". $caminho . "'><img src='assets/images/" . $nome . "'></a></section>";
							$count = 0;
							$count++;
...
<footer>
	...
	<section class="row">
			...
			<section class="col-md-12">
				...
				<a href="https://www2.faccat.br/portal/"><img src="assets/images/logofaccat.png"></a>
